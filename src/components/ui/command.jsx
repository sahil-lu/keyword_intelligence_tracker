...
function CommandInput({
  ...
  return (
    <div data-slot="command-input-wrapper" className="p-1 pb-0">
      <InputGroup
        className="h-8! rounded-lg! border-oklch(0.922 0 0)/30 bg-oklch(0.922 0 0)/30 shadow-none! *:data-[slot=input-group-addon]:pl-2! dark:border-oklch(1 0 0 / 15%)/30 dark:bg-oklch(1 0 0 / 15%)/30">
