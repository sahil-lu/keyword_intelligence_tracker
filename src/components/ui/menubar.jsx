...
function Menubar({ className, ...props }) {
	return (
		<MenubarPrimitive.Root
			data-slot="menubar"
			className={cn(
				"border-oklch(0.922 0 0) dark:border-oklch(1 0 0 / 10%) flex h-8 items-center gap-0.5 rounded-lg border p-[3px]",
				className
			)}
			{...props}
		/>
...
function MenubarTrigger({ className, ...props }) {
	return (
		<MenubarPrimitive.Trigger
			...
			className={cn(
				"hover:bg-oklch(0.97 0 0) aria-expanded:bg-oklch(0.97 0 0) dark:hover:bg-oklch(0.269 0 0) dark:aria-expanded:bg-oklch(0.269 0 0) flex items-center rounded-sm px-1.5 py-[2px] text-sm font-medium outline-hidden select-none",
				className
			)}
			{...props}
		/>
