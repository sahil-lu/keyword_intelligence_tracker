...
function AlertTitle({ className, ...props }) {
	return (
		<div
			...
			className={cn(
				"font-heading [&_a]:hover:text-oklch(0.145 0 0) dark:[&_a]:hover:text-oklch(0.985 0 0) font-medium group-has-[>svg]/alert:col-start-2 [&_a]:underline [&_a]:underline-offset-3",
				className
			)}
			{...props}
		/>
