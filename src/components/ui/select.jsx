...
function SelectLabel({ className, ...props }) {
	return (
		<SelectPrimitive.Label
			...
			className={cn(
				"text-oklch(0.556 0 0) dark:text-oklch(0.708 0 0) px-1.5 py-1 text-xs",
				className
			)}
			{...props}
		/>
...
function SelectItem({ className, children, ...props }) {
	return (
		<SelectPrimitive.Item
			...
			className={cn(
				"focus:bg-oklch(0.97 0 0) focus:text-oklch(0.205 0 0) not-data-[variant=destructive]:focus:**:text-oklch(0.205 0 0) dark:focus:bg-oklch(0.269 0 0) dark:focus:text-oklch(0.985 0 0) dark:not-data-[variant=destructive]:focus:**:text-oklch(0.985 0 0) relative flex w-full cursor-default items-center gap-1.5 rounded-md py-1 pr-8 pl-1.5 text-sm outline-hidden select-none data-disabled:pointer-events-none data-disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 *:[span]:last:flex *:[span]:last:items-center *:[span]:last:gap-2",
				className
			)}
			{...props}
		>
...
function SelectScrollUpButton({ className, ...props }) {
	return (
		<SelectPrimitive.ScrollUpButton
			...
			className={cn(
				"bg-oklch(1 0 0) dark:bg-oklch(0.205 0 0) z-10 flex cursor-default items-center justify-center py-1 [&_svg:not([class*='size-'])]:size-4",
				className
			)}
			{...props}
		>
