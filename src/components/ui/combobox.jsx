...
function ComboboxItem({ className, children, ...props }) {
	return (
		<ComboboxPrimitive.Item
			...
			className={cn(
				"data-highlighted:bg-oklch(0.97 0 0) data-highlighted:text-oklch(0.205 0 0) not-data-[variant=destructive]:data-highlighted:**:text-oklch(0.205 0 0) dark:data-highlighted:bg-oklch(0.269 0 0) dark:data-highlighted:text-oklch(0.985 0 0) dark:not-data-[variant=destructive]:data-highlighted:**:text-oklch(0.985 0 0) relative flex w-full cursor-default items-center gap-2 rounded-md py-1 pr-8 pl-1.5 text-sm outline-hidden select-none data-disabled:pointer-events-none data-disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
				className
			)}
			{...props}
		>
...
function ComboboxChip({ className, children, showRemove = true, ...props }) {
	return (
		<ComboboxPrimitive.Chip
			...
			className={cn(
				"bg-oklch(0.97 0 0) text-oklch(0.145 0 0) dark:bg-oklch(0.269 0 0) dark:text-oklch(0.985 0 0) flex h-[calc(--spacing(5.25))] w-fit items-center justify-center gap-1 rounded-sm px-1.5 text-xs font-medium whitespace-nowrap has-disabled:pointer-events-none has-disabled:cursor-not-allowed has-disabled:opacity-50 has-data-[slot=combobox-chip-remove]:pr-0",
				className
			)}
			{...props}
		>
